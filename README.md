...
[![Build Status](https://travis-ci.org/Services-Sandbox/example-travis-ci-php.svg?branch=master)](https://github.com/Services-Sandbox/example-travis-ci-php/blob/master/ci-flow.png)
